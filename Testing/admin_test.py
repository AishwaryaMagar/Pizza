...
class TestAdmin(StaticLiveServerTestCase):
    ...
    def test_admin(self):
        self.driver.find_element_by_name('username').send_keys('Tanvi')
        self.driver.find_element_by_name('password').send_keys('tanvi')
        self.driver.find_element_by_name('btnk').click()
        time.sleep(2)
        print("LOGIN SUCCESFULL")

        self.driver.find_element_by_name("Pizza").send_keys('Capsi Pizza')
        self.driver.find_element_by_name("Price").send_keys('100')
        self.driver.find_element_by_name('add').click()
        time.sleep(2)
        print("ADD SUCCESFULL")

        #All Orders
        self.driver.find_element_by_partial_link_text("All Orders")
        self.driver.find_element_by_xpath('//a[contains(@href,"/adminorder/")]')
        self.driver.find_element_by_name('alloredr').click()
        time.sleep(2)
        print("ALL ORDER SUCCESFULL")
        
        # BACk To home page
        self.driver.find_element_by_partial_link_text("Back")
        self.driver.find_element_by_xpath('//a[contains(@href,"/admin/homepage/")]')
        self.driver.find_element_by_name('backbtn').click()
        print("BACK SUCCESFULL")

        #Logout
        self.driver.find_element_by_partial_link_text("Logout")
        self.driver.find_element_by_xpath('//a[contains(@href,"/admin/logout/")]')
